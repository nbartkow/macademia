...
<div class="clear left" id="other_info">
  ...
  <div class="personLinks left">
    ...
    <div class="customLink customLinkTemplate clear">
      <div class="clear linkField left"><input type="text" class="clearDefault" prompt="link name"></div>
...
<div class="clear" id="submit_edits"><button class="button icon_user" type="submit"><g:message code="nimble.link.registeraccount" /></button> or <a href="#">Cancel</a></div>
</g:form>
</div>
