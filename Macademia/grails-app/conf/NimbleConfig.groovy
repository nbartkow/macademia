...
nimble {
    ...
    fields {
        ...
        enduser {
            ...
            profile = ['fullName', 'email', 'department', 'institution', 'imageSubpath', 'links', 'title']
        }
        enduserEdit {
            user = ['fullName', 'department', 'imageSubpath', 'links', 'title']
        }
    ...
    implementation {
    	user = "org.macademia.User"
    	profile = "org.macademia.Person"
    }
}
